  ...
  fun render() = runTest {
    fun HTMLElement.assertHtml(count: Int, upgraded: Boolean) {
      assertEquals(
        ...
        }">""" + """<div class="mdc-elevation-overlay">""" + """<span class="mdc-button__ripple"></span>""" + """<span class="mdc-button__focus-ring"></span>""" + """<span class="mdc-button__label">Clicked $count times</span></button>""",
        actual = innerHTML
      )
    }
